...
class MarioLand2World(World):
    ...
    def fill_slot_data(self):
        ...
        shark_count = [self.multiworld.worlds[self.player].sprite_data
            ["Turtle Zone 1"][i]["sprite"]
            for i in (27, 28)].count("Shark")
        crane_count = [self.multiworld.worlds[self.player].sprite_data
            ["Mario Zone 3"][i]["sprite"]
            for i in (17, 18, 25)].count("Claw Grabber")
